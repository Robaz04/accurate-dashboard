    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-eco-white px-4">
      ...
      <div className="w-full max-w-md bg-white p-8 rounded-2xl shadow-xl shadow-forest-deep/5 border border-sage-mist/20">
        ...
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-bold text-forest-deep tracking-tight">
            Accurate Dashboard
          </h2>
          <p className="text-sm text-sage-mist/80 mt-1">
            Sistem Pemantauan Kehutanan Modern
          </p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-5">
          <div>
            <label
              htmlFor="token"
              className="block text-sm font-semibold text-forest-deep mb-2"
            >
              Security Token
            </label>
            <input
