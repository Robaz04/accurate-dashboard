    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-6 rounded-2xl border border-sage-mist/30 shadow-sm">
                <div>
                    <h1 className="text-2xl font-bold text-forest-deep">Master Customer</h1>
                    <p className="text-sm text-emerald-moss/80">Lihat data customer dari Accurate.</p>
                </div>
            </div>
