            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-eco-white/60 text-forest-deep text-xs font-bold uppercase tracking-wider border-b border-sage-mist/20">
                  ...
                  <th className="py-3 px-6">Nomor Item</th>

                  <th className="py-3 px-6">Nama Item</th>

                  <th className="py-3 px-6">Tipe</th>

                  <th className="py-3 px-6">UPC</th>

                  <th className="py-3 px-6 text-right">Available to Sell</th>
                </tr>
              </thead>
